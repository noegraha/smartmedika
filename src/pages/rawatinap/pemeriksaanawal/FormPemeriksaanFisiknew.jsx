...
import { PemeriksaanFisikRIContext } from "../context/PemeriksaanFisikRIContext";
...
const FormPemeriksaanFisikNew = (props) => {
  ...
  } = useContext(PemeriksaanFisikRIContext);
  ...
  return (
    <div>
      {/* <Button
        onClick={() => {
          detailPemfisik(curpasRI.registrasiId, "1");
        }}
      >
        ambil
      </Button> */}
        ...
        <Tabs defaultActiveKey="1" type="card">
          <TabPane tab="Kepala" key="1">
            <Card size="small">
              ...
              <Form.Item
                label={
                  <div style={{ fontWeight: "bolder" }}>Mulut (Bibir)</div>
                }
                style={{ marginBottom: 0 }}
                {...layout}
              >
          ...
          <TabPane tab="Urogenital" key="5">
            <Card size="small">
              <Form {...layout}>
                ...
                {curpasRI.jenisKelamin === "PEREMPUAN" ? (
                  <Form.Item
          ...
          <TabPane tab="Extermitas & Status Lokalis" key="6">
            <Card size="small">
              <Form {...layout}>
                ...
                <Form.Item
                  label={
                    <div style={{ fontWeight: "bolder" }}>Ket Lokalis</div>
                  }
                  style={{ marginBottom: 0 }}
                >
                  <TextArea
                    value={lokalisKeterangan}
                    rows={1}
                    onChange={(e) => setlokalisKeterangan(e.target.value)}
                  />
                </Form.Item>
              </Form>
            </Card>
        ...
        <Row>
          <Col span={12}>
            <Button
              ...
              disabled={
                pemfisikId === 0 || pemfisikId === "" || pemfisikId === null
                  ? true
                  : false
              }
            >
...
export default FormPemeriksaanFisikNew;
