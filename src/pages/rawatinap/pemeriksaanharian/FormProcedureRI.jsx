    ...
    for (var i = 0; i < pros.length; i++) {
      ...
      if (elementsIndex === -1) {
        ...
        prosedurBaru.push({
          ...
          prosedurId: detprosedur[i].prosedurId.trim(),
          ruangId: detprosedur[i].ruangId,
          pegawaiId: detprosedur[i].pelaksanaId,
          userId: detprosedur[i].userId,
          clientHost: detprosedur[i].clientHost,
          clientIp: detprosedur[i].clientIp,
        });
      }
    }
...
export default FormProcedureRI;
