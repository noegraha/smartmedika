        ...
        <svg className="tooth">
            <g transform={translate}>
                <polygon
                    ...
                    onContextMenu={useCM(menuConfig('atas'))}
                    className={getClassNamesByZone('atas')}
                />
                <polygon
                    points="5,15 15,15 20,20 0,20"
                    onContextMenu={useCM(menuConfig('bawah'))}
                    className={getClassNamesByZone('bawah')}
                />
                <polygon
                    points="15,5 20,0 20,20 15,15"
                    onContextMenu={useCM(menuConfig('kiri'))}
                    className={getClassNamesByZone('kiri')}
                />
                <polygon
                    points="0,0 5,5 5,15 0,20"
                    onContextMenu={useCM(menuConfig('kanan'))}
                    className={getClassNamesByZone('kanan')}
                />
                <polygon
                    points="5,5 15,5 15,15 5,15"
                    onContextMenu={useCM(menuConfig('tengah'))}
                    className={getClassNamesByZone('tengah')}
                />
                {drawToothActions()}
                <text
                    x="6"
