...
import FormSisruteRJ from "../form/FormSisruteRJ";
...
import FormRujukBalik from "../form/FormRujukBalik";
import ButtonListKontrolBPJS from "../komponen/ButtonListKontrolBPJS";
import FormSPPR from "../form/FormSPPR";
...
const SuratKontrol = () => {
  ...
  const [formulir, setForm] = useState("pulang");
      ...
      >
        ...
        {kontrol ? (
          kontrolform === 1 ? (
            ...
            // Kontrol BPJS
            <div>
              <Spin tip="Sedang memuat data dari BPJS" spinning={loadingBPJS}>
                        ...
                        <Input.Group compact>
                          ...
                          >
                            <DatePicker
                              ...
                              format={dateFormat}
                              placeholder="Pilih Tanggal"
                              value={tanggalkontrolBPJS}
                              onFocus={() => getExpiredRujukan(nosep)}
                              disabledDate={
