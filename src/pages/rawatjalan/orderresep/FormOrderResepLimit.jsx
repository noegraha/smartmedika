      ...
      render: (text, record, index) => (
        <Space>
          <Button
            ...
            size="small"
            onClick={() => {
              // onTampilRacikan(record.noRacik, index);
              setOpen(true);
            }}
  ...
  const simpanOrder = () => {
    if (pelaksana === null) {
      ...
      if (total >= 200000) {
        Modal.warning({
          content:
            "Sesuai peraturan pasien BPJS total biaya resep melebihi limit klaim. Silahkan atur order kembali.",
        });
      } else {
        ...
        <Col span={spanOrder ? 14 : 24}>
          ...
          >
                    ...
                    <>
                      <Table.Summary.Row>
                        ...
                        <Table.Summary.Cell index={1} colSpan={1} align="right">
                          <Text
                            type={totalHarga > 200000 ? "danger" : "success"}
                            strong
                          >
                            Rp.{" "}
                        ...
                        {totalHarga > 200000 ? (
                          <Table.Summary.Cell index={0} colSpan={4}>
                            <Text type="warning">
                              Total melebihi limit, silahkan atur kembali
                            </Text>
                          </Table.Summary.Cell>
                        ) : (
                          <></>
              ...
              >
                ...
                <Column
                  ...
                  render={(items) => (
                    <span>
                      Rp.{" "}
                      {items.hargaTotal.toLocaleString("id-id", {
                        minimumFractionDigits: 2,
                      })}
                    </span>
                  )}
            ...
            <Card
              ...
              loading={loadingResep}
              extra={
                <Button onClick={() => setTampilRacikan(false)}>Kembali</Button>
              }
            >
                        ...
                        >
                          ...
                          >
                            {masterjnsracikan.map((p) => (
                              <Option
                                value={p.JenisRacikId + "-" + p.Deskripsi}
                              >
                                {p.Deskripsi}
                              </Option>
                            ))}
