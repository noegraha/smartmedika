...
const DetailPasienAssesment = () => {
  const { detailjmlPasienMutasi } = useContext(LaporanAskepContext);
  const [page, setPage] = useState(1);
  return (
    <div>
      <Card size="small" title="Detail Pasien Assesment">
        <Table
        ...
        >
          ...
          <Column
            ...
            render={(detailjmlPasienMutasi) => (
              <span>
                {dayjs(detailjmlPasienMutasi.TanggalAssesment).format(
                  "DD-MM-YYYY HH:mm"
                )}
              </span>
            )}
...
export default DetailPasienAssesment;
