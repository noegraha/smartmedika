...
const RencanaTindakLanjut = () => {
  ...
  //           code: rm13.diagnosaMasuk,
  //           display: rm13.diagnosaMasukDesk,
  //         },
  //       ],
  //       text: rm13.anjuran,
  //     },
  ...
  //     },
  //   ],
  //   patientInstruction: rm13.anjuran,
  // };

  const klikRefresh = async () => {
    const codeGroups = ["103"];
  ...
  const klikPost = () => {
    let dataTindakLanjut = {
      resourceType: "ServiceRequest",
      identifier: [
        {
          system: `http://sys-ids.kemkes.go.id/servicerequest/${ihsRS}`,
          value:
            Object.keys(rm13).length === 0
              ? ""
              : rm13.resumePerawatanId.toString(),
        },
      ],
      status: "active",
      intent: "original-order",
      ...
      reasonCode: [
        {
          coding: [
            {
              system: "http://hl7.org/fhir/sid/icd-10",
              code: diagnosissementara.code,
              display: diagnosissementara.display,
            },
          ],
        },
      ],
    ...
    postResource(dataTindakLanjut, "ServiceRequest", "103");
  }
...
export default RencanaTindakLanjut;