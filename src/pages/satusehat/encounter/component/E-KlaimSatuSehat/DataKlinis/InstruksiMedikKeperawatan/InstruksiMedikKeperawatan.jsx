...
const InstruksiMedikKeperawatan = () => {
    const {
        ihsPasien,
        identitasPx,
        paramEncounter,
    ...
    return (
        <div>
                    ...
                    <Col span={12}>
                        <Button
                            ...
                            onClick={() => {
                                ...
                                setketerangan("Penanganan DB Pasien dilakukan dengan pemberian pengobatan melalui infus, pemeriksaan laboratorium jumlah trombosit dalam darah, pemeriksaan radiologi CXR");
                            }}
                            icon={<PlusOutlined />}
                        >
                            Tambah
            ...
            >
                ...
                >
                    Tambah Instruksi Medik dan Keperawatan Pasien
                </Divider>
                <Spin
                    spinning={spCvg}
                    tip="Loading... 😁"
...
export default InstruksiMedikKeperawatan