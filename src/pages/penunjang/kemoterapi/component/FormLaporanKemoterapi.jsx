...
const FormLaporanKemoterapi = () => {
  ...
  for (let i = 0; i < 20; i++) {
    data.push({
      ...
      Jam: "23:59",
      Implementasi:
        "Implementasi Implementasi Implementasi Implementasi Implementasi Implementasi Implementasi Implementasi Implementasi Implementasi",
    });
  }
  ...
  const klikSimpanImp = () => {
    ...
    if (dayjs(jamImp).format("hh:mm") === "12:00") {
      ...
      Modal.warning({
        title: "Peringatan!",
        content: "Implementasi masih kosong!",
      });
  ...
  const klikSimpan = () => {
    ...
    if (
      dayjs(tglPmr).format("YYYY-MM-DD") !==
      dayjs(tglOrder).format("YYYY-MM-DD")
    ) {
      Modal.warning({
        title: "Peringatan!",
        content: "Tanggal List Order tidak sama dengan Tanggal Penyinaran!",
      });
    } else if (!perawat) {
      ...
      Modal.warning({
        title: "Peringatan!",
        content: "Total Siklus masih kosong!",
      });
    } else if (!siklusUtama) {
      Modal.warning({
        title: "Peringatan!",
        content: "Siklus Utama masih kosong!",
      });
    }
    ...
    <div>
      <Card loading={spSimpanKemoLaporan}>
        <Row style={{ marginBottom: "2px" }}>
          ...
          <Col span={9}>
            <Input value={diagnosa} size="small" style={{ width: "100%" }} />
          </Col>
        </Row>

        <Row style={{ marginBottom: "2px" }}>
          <Col span={3}>Siklus Utama :</Col>
        ...
        >
          {"*) Inputan diatas akan mulai TIDAK AKTIF per 1 Januari 2024"}
        </span>
            ...
            <Spin spinning={spProtokol}>
              {Object.keys(protokolKemo).length > 0 ? (
                <div style={{ flex: 1 }}>
                  ...
                  <Row>
                    <Col span={24}>{parse(protokolKemo.ObatProtokol)}</Col>
                  </Row>
                  <Row>
                    <Col span={24}>{parse(protokolKemo.ProsedurProtokol)}</Col>
                  </Row>
                  <Row>
                ...
                <Empty
                  description={
                    <span>
                      Belum ada Protokol Kemoterapi.
                      <br />
                      Pemilihan Protokol Kemoterapi di inputkan melalui
                      Poliklinik.
                    </span>
                  }
                />
      ...
      >
        ...
        >
          <h3
            style={{
              color: daysDifference > 7 ? "#d9d9d9" : "black",
              backgroundColor: daysDifference < 5 ? "#b7eb8f" : "white",
            }}
          >
            <ExclamationCircleTwoTone /> Update tanggal : 18-03-2025
          </h3>
          <ul
            style={{
              color: daysDifference > 7 ? "#d9d9d9" : "black",
          ...
          >
            <li>
              Penambahan inputan <b>Total Siklus</b> untuk memberikan informasi
              terkait berapa siklus pasien tersebut harus menjalani kemoterapi
              pada siklus yang sedang dijalani. <b>(*Wajib diisi)</b>
            </li>
            <li>
              Penambahan informasi <b>Riwayat Kemoterapi</b> pasien yang telah
              dibuatkan Laporan Kemoterapi pada Tab Menu Riwayat Kemoterapi.
            </li>
          </ul>
          <h3
            style={{
              color: 8 > 7 ? "#d9d9d9" : "black",
              backgroundColor: 8 < 5 ? "#b7eb8f" : "white",
            }}
          >
            <ExclamationCircleTwoTone /> Update tanggal : 14-01-2025
          </h3>
          <ul
            style={{
              color: 8 > 7 ? "#d9d9d9" : "black",
          ...
          >
            <li>
              Penambahan <b>Indikator PENGISIAN Protokol Kemoterapi</b> pada
          ...
          >
            <ExclamationCircleTwoTone /> Update tanggal : 23-09-2024
          </h3>
          <ul
            style={{
              color: 8 > 7 ? "#d9d9d9" : "black",
          ...
          >
            <li>
              Penambahan menu <b>Master Protokol Kemoterapi</b> (Menu ini berada
              dibawah menu Laporan Kemoterapi), digunakan untuk menambahkan
              Master Protokol yang belum tersedia didalam sistem. Protokol
              Kemoterapi dikelompokan berdasarkan dokter.
            </li>
            <li>
              Penambahan fitur input <b>Protokol Kemoterapi</b> jika dari rawat
              jalan belum ada protokol yang diinputkan.
            </li>
            <li>
              Protokol kemoterapi hanya bisa diubah{" "}
              <b>jika nama ruang dan user input sama</b>.
            </li>
            <li>
              Tombol <b>Riwayat Protokol</b> (di form Protokol Kemoterapi)
              digunakan untuk menampilkan riwayat protokol kemoterapi dan ada
              aksi <b>Salin</b> untuk mempermudah jika protokol yang diinputkan
              sama dengan protokol pelayanan sebelumnya.
            </li>
            <li>
              Penambahan informasi <b>DPJP</b> di PageHeader Nama Pasien.
            </li>
          </ul>
        ...
        <Row gutter={[6, 6]}>
          ...
          <Col span={8}>
            ...
            >
              ...
              >
                <Option value="Visual Analog Scale">Visual Analog Scale</Option>
                ...
                <Col span={24}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Option value={3}>
                        Nyeri Sangat Nyata, Seperti Kejadian Terpotong, Serangan
                        Pada Hidung <br></br>Karena Perdarahan Hidung Atau
                        Ketika Dilakukan Injeksi
                      </Option>
                      ...
                      <Option value={8}>
                        Nyeri Sangat Intens, Tidak Dapat Berfikir Secara Jernih
                        Sepanjang Waktu <br></br>Dan Sering Mengalami Perubahan
                        Kepribadian Berat Jika Nyeri Muncul Sepanjang Waktu
                      </Option>
                      <Option value={9}>
                ...
                <Col span={24}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Option value={2}>
                        Sering Meringis, Menangis, Mengerinyit, Mengerutkan Dahi
                      </Option>
                    </Select>
                  </Form.Item>
                  <Form.Item
                  ...
                  >
                    ...
                    >
                      <Option value={0}>
                        Tidur Telantang Tenang, Posisi Tangan Tidak Diatas Tubuh
                      </Option>
                      <Option value={1}>Melindungi Area Tubuh, Tekanan</Option>
                  ...
                  >
                    ...
                    >
                      ...
                      <Option value={1}>
                        Tekanan Darah Sistolik &gt; 20 mmHg, Nadi &gt; 20/menit
                      </Option>
                      <Option value={2}>
                        Tekanan Darah Sistolik &gt; 30 mmHg, Nadi &gt; 25/menit
                      </Option>
                    </Select>
                  </Form.Item>
                  <Form.Item
                  ...
                  >
                    ...
                    >
                      ...
                      <Option value={1}>
                        RR &gt; 10 Diatas Garis Dasar atau 5% Dibawah SpO2 Tidak
              ...
              <Row gutter={[6, 6]}>
                <Col span={24}>
                  ...
                  >
                    <img
                      src={skalanyeripng}
                      alt="Tampilan untuk skala nyeri"
                      style={{ width: "333px" }}
                    />
                    <Slider
                      min={0}
            ...
            {metodeResikoJatuh === "HUMPTY DUMPTY" ? (
                  ...
                  >
                    ...
                    >
                      ...
                      <Option value="Diagnosa-3">
                        Perubahan Dalam Oksigenasi <br></br>(Diagnosa espirasi,
                        Dehidrasi, Anemia, Anoreksia, Pingsan/Pusing){" "}
                      </Option>
                  ...
                  >
                    ...
                    >
                      <Option value="PemakaianObat-3">
                        Memakai Lebih Dari Satu Obat Berikut: Sedasi, Hypnotic,{" "}
                        <br></br>Barbiturares, Phenothiazines, Anti Depressants,
              ...
              <Row gutter={[6, 6]}>
                <Col span={24}>
                  ...
                  <span style={{ fontWeight: "bolder" }}>Penglihatan/Mata</span>
                  <br />
                  <Row>
                  ...
                  <Row>
                    <Col span={12}>
                      ...
                      Tidak Bisa Menahan Kencing, Inkontinensia, Nokturia)
                    </Col>
                    <Col span={12}>
                      <Select
                        placeholder="..."
                ...
                <Col span={24}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Option value="RiwayatJatuh-0">Tidak Pernah Jatuh</Option>
                    </Select>
                  </Form.Item>
      ...
      >
        ...
        <br />
        <Form.Item style={{ marginBottom: 0 }}>
          <Input type="number" suffix="Cm" placeholder="..." value={bblila} />
        </Form.Item>
      </Modal>
          ...
          <Col span={21}>
            <Input.Group compact>
              <Select
                ...
                // size='small'
                onSelect={(e) => {
                  let temp = optProtKemo.filter((item, index) => item.Id === e);
                  setidProt(e);
