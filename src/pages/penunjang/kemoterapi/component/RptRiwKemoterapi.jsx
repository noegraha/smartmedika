              ...
              {rptProtKemo && Object.keys(rptProtKemo).length > 0 ? (
                <div style={{ flex: 1 }}>
                  <Row>
                    <Col span={6}>DPJP</Col>
                    <Col span={18}>
                      : <b>{rptProtKemo.NAMADOKTER}</b>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={6}>Nama Protokol</Col>
                    <Col span={18}>
                      : <b>{rptProtKemo.NamaProtokol}</b>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={24}>{parse(rptProtKemo.ObatProtokol)}</Col>
                  </Row>
                  <Row>
                    <Col span={24}>{parse(rptProtKemo.ProsedurProtokol)}</Col>
                  </Row>
                  <Row>
