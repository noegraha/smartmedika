...
function Signature() {
  ...
  //     if (retry < 20) {
  //       setTimeout(checkForSigCaptX, 5000);
  //     }
  //     else {
  ...
  function generateImage() {
    ...
    props.setTtdPasien(signatureCanvas.toDataURL().substr(22));
    if (props.jenisPenerima === "2") { props.setTtdKeluargaPasien(signatureCanvas.toDataURL().substr(22)) }
  }
    ...
    <div>
      <div id="signatureDiv">
        {/* <Image
          ...
          style={{ marginTop: '5px' }}
        /> */}
        <img id="signatureImage" src={`data:image/jpeg;base64,` + props.ttdPasien} />
      </div>
      <div>
        <input type="button" id="signButton" value="Ttd" onClick={() => tabletDemo()} />
      </div>
    </div>
  )
}
